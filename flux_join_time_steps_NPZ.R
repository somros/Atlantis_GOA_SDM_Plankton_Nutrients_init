...
romsfile <- 'C:/Users/Alberto Rovellini/Documents/GOA/SDM/Plankton_and_nutrients/data/ROMS_climatologies/s3_clim.nc'
...
plankton <- function(this_variable){
  ...
  write.csv(var_out, paste0('../outputs/summer_init/',this_variable,'.csv'), row.names = FALSE)
}
